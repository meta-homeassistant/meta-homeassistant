**WARNING**: This is work in progress and requires changes in [`meta-python`](https://github.com/bachp/meta-openembedded/tree/python-packages) that are not yet upstream!!

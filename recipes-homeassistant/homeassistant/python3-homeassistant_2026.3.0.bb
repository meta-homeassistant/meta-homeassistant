...
RDEPENDS:${PN} += "\
    python3-aiodns (>=4.0.0) \
    python3-aiohasupervisor (>=0.3.3) \
    ...
    python3-cronsim (>=2.7) \
    python3-fnv-hash-fast (>=1.6.0) \
    python3-hass-nabucasa (>=1.15.0) \
